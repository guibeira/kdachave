...
class Pessoa(models.Model):
    ...
    telefoneComercial = models.CharField('Telefone Comercial', max_length=100, null=True, blank=True)
    telefoneResidencial = models.CharField('Telefone Residencial', max_length=100, null=True, blank=True)
    celular1 = models.CharField('Celular 1', max_length=100, null=True, blank=True)
    celular2 = models.CharField('Celular 2',max_length=100, null=True, blank=True)
